...
(function(root, factory) {
    ...
    var drag = $special.drag = {
        ...
        defaults: {
            ...
            click: false,
            // "x" or "y" to indicate which axis the drag event is interested in and consequently whether
            // scrolling on touch devices will be prevented
            axis: null,
            // disables the prevent default calls which can be handy if you don't want to torch scroll on touch
            allowDefault: false
        },
        ...
        handler: function(event) {
            ...
            switch (event.type) {
                ...
                case !dd.dragging && 'MSPointerMove':
                    if (!dd.allowDefault) event.preventDefault();
                    if (!dd.allowDefault) dd.startEvent.preventDefault();
                    //! fall through!
